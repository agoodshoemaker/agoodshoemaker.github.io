...
1. Draw an arbitrary point $C$  on a line segment $AB$.
	...
	<figure>
		<img src="/assets/posts/2019-06-02-problem-1/f2.png" width="65%" height="65%" />
...
2. Mark a point $D$ that doesn’t lie on the line $AB$.
	...
	<figure>
		<img src="/assets/posts/2019-06-02-problem-1/f3.png" width="65%" height="65%" />
		<br>
...
3. Connect points $C$ and $D$.
	...
	<figure>
		<img src="/assets/posts/2019-06-02-problem-1/f4.png" width="65%" height="65%" />
		<br>
...
4. Construct the angle bisectors of $\angle ACD$ and $\angle BCD$
	...
	<figure>
		<img src="/assets/posts/2019-06-02-problem-1/f5.png" width="65%" height="65%" />
		<br><br>
...
5. Draw a line parallel to $AB$ and label the points where it intersects the two angle bisectors as $M$ and $N$.
	...
	<figure>
		<img src="/assets/posts/2019-06-02-problem-1/f6.png" width="65%" height="65%" />
		<br><br>
...
Now consider the triangles $OCN$ and $ONC$. Using the above result and keeping in mind that $MC$ and $NC$ are angle bisectors, the following holds true:
