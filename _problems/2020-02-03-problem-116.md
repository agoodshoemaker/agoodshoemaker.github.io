...
Using this rate in the second equation and the second approximation we are given $(\frac{26}{25})^{20} \approx 2.19$, we get:
...
A Nimbus-$2000$ would have cost a $100$ Galleons during Harry's time at Hogwarts.