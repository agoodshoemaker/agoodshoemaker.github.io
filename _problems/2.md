...
In a trapezium, the line parallel to the bases and passing through the intersection point of the diagonals is drawn. Compute the length of this line inside the trapezium, if the bases are $a$ and $b$ units long.
...
$$
FE = EG = BC \cdot \cfrac{a}{a + b} = b \cdot \cfrac{a}{a + b}
$$
...
For an interactive version of the final construction, please checkout this <a href="/assets/problems/2/home.html" target="blank">link</a>.
