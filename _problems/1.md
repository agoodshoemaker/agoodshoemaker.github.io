...
Prove that the median to a side of a triangle bisects every line segment drawn parallel to this side, where the end points of the segment lie on the other two sides.
...
For an interactive version of the final image, please checkout this <a href="/assets/problems/1/home.html" target="blank">link</a>.
